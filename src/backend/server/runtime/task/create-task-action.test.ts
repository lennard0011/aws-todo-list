...
describe('CreateTaskAction', () => {
    ...
    it('should log messages during execution', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(`Task: ${JSON.stringify(createTaskDto)}`);
    ...
    it('should throw an error if DynamoDbClient.createTask fails', async () => {
        ...
        // Act & Assert
        await expect(createTaskAction.handle(userId, createTaskDto)).rejects.toThrow('DynamoDB error');
