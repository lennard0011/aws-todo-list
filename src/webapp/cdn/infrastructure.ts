...
import { AllowedMethods, CachedMethods, Distribution, OriginAccessIdentity, SecurityPolicyProtocol, ViewerProtocolPolicy } from "aws-cdk-lib/aws-cloudfront";
...
export class ContentDeliveryNetwork extends Construct {
    constructor(scope: Construct, id: string, props: Props) {
        ...
        const distribution = new Distribution(this, 'CDNWebDistribution', {
            ...
            defaultBehavior: {
                origin: new S3Origin(sourceBucket, {originAccessIdentity: cloudfrontOAI}),
